...
def create():
    ...
    io.dump(dict1, pickle_file)
    pickle_file.close()
    t2 = datetime.now()
    total = t2-t1
    print("Time taken to create " + str(total))
...
if len(sys.argv) < 2 or len(sys.argv) > 2:
    ...
    t2 = datetime.now()
    total = t2-t1
    print("Total files are", str(len(list1)))
    print("Time taken to search " + str(total))
